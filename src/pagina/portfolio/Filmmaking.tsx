      ...
      <section className="px-6 py-16">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <ScrollReveal direction="left" overflow="visible" className="space-y-6">
              <p className="text-primary text-sm font-bold tracking-wider uppercase">Serviço</p>
              <h1 className="font-display text-[clamp(2.5rem,10vw,8rem)] leading-none font-bold text-foreground">FILMMAKING</h1>
            ...
            <ScrollReveal direction="right" overflow="visible" className="bg-gradient-dark p-8 border-4 border-primary">
